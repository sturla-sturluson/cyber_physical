...
class BasePS4Listener:
    ...
    accelerate_button:PS4Button = PS4Button(ButtonType.AXIS,id=5,name="R2",released=-1,min=-1,max=1)
    decelerate_button:PS4Button = PS4Button(ButtonType.AXIS,id=2,name="L2",released=-1,min=-1,max=1)
    ...
    increase_max_speed_button:PS4Button = PS4Button(ButtonType.BUTTON,id=5,name="R1",released=0)
    decrease_max_speed_button:PS4Button = PS4Button(ButtonType.BUTTON,id=4,name="L1",released=0)
    ...
    def _manual_control_handler(self):
        ...
        if(self.is_auto_drive):
            return
        self.forward_motion,self.turning_motion = self.ps4_input.get_values_from_game(self.accelerate_button,self.brake_button,self.decelerate_button,self.turn_button)
