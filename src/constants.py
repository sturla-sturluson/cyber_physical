...
A_C1_PIN = int(os.getenv("A_C1_PIN", DEFAULT_A_C1_PIN ))
A_C2_PIN = int(os.getenv("A_C2_PIN", DEFAULT_A_C2_PIN ))
BIN1_PIN = int(os.getenv("BIN1_PIN", DEFAULT_BIN1_PIN ))
BIN2_PIN = int(os.getenv("BIN2_PIN", DEFAULT_BIN2_PIN ))
B_C1_PIN = int(os.getenv("B_C1_PIN", DEFAULT_B_C1_PIN ))
B_C2_PIN = int(os.getenv("B_C2_PIN", DEFAULT_B_C2_PIN ))
